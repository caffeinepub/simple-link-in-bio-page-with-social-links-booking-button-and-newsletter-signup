...
export class Backend implements backendInterface {
    ...
    async getAllSubscribers(): Promise<Array<[string, Time]>> {
    ...
    async getSubscriber(arg0: string): Promise<Time> {
        if (this.processError) {
            try {
    ...
    async joinNewsletter(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.joinNewsletter(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
